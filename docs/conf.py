...
def linkcode_resolve(domain, info):
    ...
    if not package.startswith('ar_rhino'):
        return None
    ...
    return f"https://github.com//ar_rhino/blob/master/src/{filename}.py#L{lineno}"
...
html_theme_options = {
    "package_name"    : "ar_rhino",
    "package_title"   : project,
    "package_version" : release,
    "package_author"  : "",
    "package_docs"    : "https://.github.io/ar_rhino/",
    "package_repo"    : "https://github.com//ar_rhino",
    "package_old_versions_txt": "https://.github.io/ar_rhino/doc_versions.txt"
}
